...
<style>
    ...
    /* Ensure messages don't hide behind fixed bar */
    .main .block-container {
...
st.markdown("""
<style>
/* ── FIXED CHATBOX - covers all Streamlit versions ── */

/* Streamlit 1.30+ uses stBottom */
...
/* Push messages up so last one is visible above the bar */
